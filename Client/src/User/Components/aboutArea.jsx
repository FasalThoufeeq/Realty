...
const AboutArea = () => {
  return (
    <section className="about p-100 bg-gray">
      <div className="container">
        <div className="row">
          <div className="col-xl-6 col-12">
            <div className="img-block ">
              <img
                src="./assets/media/about/img-1.png"
                className="big-img"
                alt=""
              />
          ...
          <div className="col-xl-6 col-12">
            <div className="content">
              <h2 className="fw-6 fs-48 color-dark-2 mb-16 ls-1 lh-120 text-uppercase">
                Connecting You with Your Dream Home
              </h2>
              <h5 className="fw-6 fs-19 color-dark-3 mb-8 font-sec">
                History:
              </h5>
              <p className="mb-16">
                Homely is a modern real estate platform dedicated to providing
                the best experience for buyers, sellers, and agents. Our mission
                is to simplify the buying and selling process, while providing
                exceptional service and expertise. We are committed to using
                innovative technology to make real estate transactions faster,
