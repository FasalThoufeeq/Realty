...
const CheckoutArea = ({ properties }) => {
  ...
  return (
    <>
      <section className="check-out bg-gray pt-50 pb-100">
        <div className="container">
          <div className="heading">
            <h2 className="">Check Out Our Featured Properties</h2>
            <p>
          ...
          <Slider {...settings} className="property-slider d-flex">
            {properties.map((property) => {
              if (!property.list) {
                return null;
              }
              return (
                <div key={property?._id} className="content">
                  <div className="img-block position-relative">
                    <img src={property?.propertyImages[0]?.url} alt="" />
                    <span>₹ {property?.rateInWords}</span>
                  </div>
                  <a href="properties-detail.html">{property?.headline}</a>
                  <p>{property?.subHeading}</p>
                  ...
                  <Link
                    ...
                    className="real-btn bordered text-capitalize mb-0"
                  >
