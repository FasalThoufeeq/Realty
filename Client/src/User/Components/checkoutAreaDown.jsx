...
const CheckoutAreaDown = ({ properties }) => {
  return (
    <section className="check-out bg-white p-100">
      <div className="container">
        <div className="heading">
          <h2 className="">Our Top-Rated Properties</h2>
          <p>
            Discover our top properties, carefully selected for quality, style,{" "}
            <br />
...
CheckoutAreaDown.propTypes = {
  properties: PropTypes.array.isRequired,
};
export default CheckoutAreaDown;
